...
export interface components {
  schemas: {
    ...
    DocDir: components["schemas"]["DocNode"];
    DocFile: components["schemas"]["DocNode"] & {
      title?: string;
    };
    DocNode: {
      name?: string;
    ...
    PipelineDir: components["schemas"]["PipelineNode"];
    PipelineFile: components["schemas"]["PipelineNode"] & {
      title?: string;
      description?: string;
      arguments?: (components["schemas"]["Argument"])[];
