...
export default defineConfig({
  ...
  server: {
    ...
    port: 5173,
    headers: {
      'Content-Security-Policy': "default-src 'self' http://localhost:8000/;"
           + " img-src 'self';"
           + " style-src 'self' 'unsafe-inline' 'unsafe-hashes' https://cdn.form.io/;"
           + " connect-src 'self' http://localhost:8000/ http://localhost:8001/;"
           + " script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.form.io/"
